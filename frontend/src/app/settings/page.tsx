            ...
            <div className="max-w-5xl mx-auto py-8 px-4">
                <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <div className="md:w-3/4 bg-white rounded-lg shadow-sm border p-6">
                        ...
                        {activeTab === "timetable" && (
                            <div>
                                <h2 className="text-xl font-bold mb-6">시간표 설정</h2>
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between">
                                        <label className="text-sm font-medium text-gray-700">주말 표시</label>
                                        <label className="relative inline-flex items-center cursor-pointer">
                                            <input
                                                type="checkbox"
                                                className="sr-only peer"
                                                checked={timetableSettings.showWeekends}
                                                onChange={(e) => setTimetableSettings({ ...timetableSettings, showWeekends: e.target.checked })}
                                            />
                                    ...
                                    <div className="flex flex-col md:flex-row gap-4">
                                        <div className="w-full md:w-1/2">
                                            ...
                                            <select
                                                ...
                                                onChange={(e) => setTimetableSettings({ ...timetableSettings, startHour: e.target.value })}
                                            >
                                        ...
                                        <div className="w-full md:w-1/2">
                                            ...
                                            <select
                                                ...
                                                onChange={(e) => setTimetableSettings({ ...timetableSettings, endHour: e.target.value })}
                                            >
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-1">기본 보기</label>
                                        <select
                                            className="w-full border rounded-md px-3 py-2"
                                            value={timetableSettings.defaultView}
                                            onChange={(e) => setTimetableSettings({ ...timetableSettings, defaultView: e.target.value })}
                                        >
                                                            ...
                                                            : color === "green"
                                                                ...
                                                                : color === "purple"
                                                                    ...
                                                                    : color === "red"
                                                                        ? "bg-red-500"
                                                                        : "bg-orange-500"
                                                    } ${timetableSettings.colorTheme === color ? "ring-2 ring-offset-2 ring-gray-400" : ""}`}
                                                    onClick={() => setTimetableSettings({ ...timetableSettings, colorTheme: color })}
                                                    aria-label={`${color} 테마`}
                                                />
                                            ))}
                                        </div>
