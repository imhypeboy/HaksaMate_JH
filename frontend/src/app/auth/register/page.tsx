...
export default function RegisterPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            router.push('/auth/login'); // 회원가입 성공 시 로그인 페이지로 이동
        } catch (error: any) {
            setGeneralError(
                error.message ||
                    ...
                    <div className="rounded-md space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                } rounded-md bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:border-indigo-400 transition`}
                                placeholder="사용자 이름"
                            />
                            {errors.username && (
